...
// BufferedPipe is a structure representing a buffered pipe.
// Written data will come out the other end when read, but
...
// NewBufferedPipe() creates and initialized a buffered pipe.
